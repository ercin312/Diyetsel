...
class DiyetselButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final radius = cartoon ? 26.0 : (28.0);
    ...
    final card = AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: cartoon
            ? null
            : Border.all(
                color: AppColors.modernLine.withValues(alpha: 0.65),
                width: 0.6),
        boxShadow: cartoon
            ? const [
                BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: (cartoon ? 12 : 10),
        vertical: (cartoon ? 6 : 4)),
      decoration: BoxDecoration(
        color: color.withValues(alpha: (cartoon ? 0.2 : 0.14)),
        borderRadius: BorderRadius.circular((cartoon ? 18 : 20)),
        border: cartoon
            ? null
            : null,
        boxShadow: cartoon
